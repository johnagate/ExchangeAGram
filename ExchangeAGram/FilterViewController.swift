...
//  ExchangeAGram
//
//  Created by John Robert Agate on 12/29/14.
...
class FilterViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(collectionView: UICollectionView, didSelectItemAtIndexPath indexPath: NSIndexPath) {
        let filterImage = self.filteredImageFromImage(self.thisFeedItem.image, filter: self.filters[indexPath.item])
    ...
    func photoFilters() -> [CIFilter] {
        ...
        vignette.setValue(kIntensity * 2, forKey: kCIInputImageKey)
        vignette.setValue(kIntensity * 30, forKey: kCIInputImageKey)
